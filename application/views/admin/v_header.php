      ...
      <div class="input-group input-group-sm">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?= base_url('admin/Dashboard'); ?>" class="brand-link">
				<img src="<?= base_url(); ?>assets/catering.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
					style="opacity: .8">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item has-treeview ">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?= base_url('admin/Kupon'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Data Kupon</p>
									</a>
								</li>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?= base_url('admin/Transaksi/verifikasiPerorang'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Verifikasi (Perorang)</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('admin/Transaksi/verifikasiPerusahaan'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Verifikasi (Perusahaan)</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('admin/Transaksi/proses'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="<?= base_url('admin/Tagihan'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Tagihan</p>
									</a>
								</li>
