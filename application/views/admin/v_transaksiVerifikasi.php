                        ...
                        <table id="example1" class="table table-bordered table-striped" style="font-size:10pt">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $status; ?></td>
                                    <td>
                                        <a href="<?= base_url('admin/Transaksi/detail/'.$row->id); ?>" class="btn btn-info btn-sm">Detail</a>
                                        <a href="<?= base_url('admin/Transaksi/aksi_Verifikasi/'.$row->id); ?>" onclick="return confirm('Apakah anda yakin akan verifikasi Pembayaran?')"class="btn btn-warning btn-sm">Verifikasi</a>
                                    </td>
                                </tr>
                                <?php } ?>
