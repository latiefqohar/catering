<section id="home-section" class="hero">
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Nikmati makanan Lezat &amp; Sehat</h1>
	              <h2 class="subheading mb-4">Kami membuat menyediakan makanan lezat &amp; sehat</h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Kemudahan Memesan &amp; Harga Murah</h1>
	              <h2 class="subheading mb-4">Kami memberikan kemudahan memesan &amp; memberikan harga murah</h2>
	              <p><a href="#" class="btn btn-primary">View Details</a></p>
	            </div>
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Gratis Biaya Kirim</h3>
                <span>jika order diatas 500k</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Bahan yang segar</h3>
                <span>Bahan baku segar</span>
              </div>
            </div>    
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Memberikan Pelayanan pelanggan terbaik</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Dukungan Admin</h3>
                <span>16 Jam x 7 hari</span>
              </div>
            </div>      
          </div>
        </div>
		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(<?= base_url('assets/template/'); ?>images/category-3.jpg);">
							<div class="text px-3 py-1">
    ...
    <section class="ftco-section">
		...
		<section class="ftco-section img" style="background-image: url(<?= base_url('assets/template/'); ?>images/bg_3.jpg);">
    	<div class="container">
				<div class="row justify-content-end">
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
          	<span class="subheading">Promo hari ini</span>
            <h2 class="mb-4">Hanya untuk hari ini!!</h2>
            <p>Pilih menu dan dapatkan harga terbaik dari kami!!</p>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="<?= base_url('assets/template/'); ?>images/partner-1.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="<?= base_url('assets/template/'); ?>images/partner-2.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="<?= base_url('assets/template/'); ?>images/partner-3.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="<?= base_url('assets/template/'); ?>images/partner-4.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="<?= base_url('assets/template/'); ?>images/partner-5.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    		</div>
    	</div>
    </section>