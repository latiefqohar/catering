		...
		<div class="row mb-5">
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					<h2 class="ftco-heading-2">Catering Mama Dina</h2>
					<p>Dengan menu yang beragam dan harga yang terjangkau, kami ingin memberikan makanan yang lezat dan berkesan.</p>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4 ml-md-5">
					...
					<ul class="list-unstyled">
						...
						<li><a href="<?= base_url('Belanja'); ?>" class="py-2 d-block">Menu</a></li>
				...
				<div class="ftco-footer-widget mb-4">
					...
					<div class="block-23 mb-3">
						<ul>
							...
							<li><a href="https://api.whatsapp.com/send?phone=6282213179411"><span class="icon icon-whatsapp"></span><span class="text">082213179411</span></a></li>
							<li><a href="mailto:customer@cateringmamadina.com"><span class="icon icon-envelope"></span><span
										class="text">customer@cateringmamadina.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
