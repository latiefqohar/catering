...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Catering</b> Mama Dina</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
    <?= $this->session->flashdata('message'); ?>
    <img src="<?= base_url('assets/catering.png'); ?>" alt="Logo"  style="display: block;margin-left: auto;margin-right: auto;width: 50%;">
